...
function App() {
  ...
  function handleSetOnOff(e) {
    setOnOff((prevOnOff) => !prevOnOff);
  }

  function handleSetAct(e) {
    const newAct = e.target.textContent;
    console.log(newAct);
    setAct(newAct);
  }
  ...
  return (
    <div className="toggler">
      <RatingComp
        ...
        setAct={handleSetAct}
        onOff={onOff}
        setOnOff={handleSetOnOff}
      />
      <ThankyouComp act={act} onOff={onOff} />
    </div>
  );
}

function RatingComp({ act, setAct, onOff, setOnOff }) {
  return (
    <div className={`main-container ${onOff ? "on" : "off"}`}>
      ...
      <div className="button-container">
        <button className={act == "1" ? "btn active" : "btn"} onClick={setAct}>
          1
        </button>
        <button className={act == "2" ? "btn active" : "btn"} onClick={setAct}>
          2
        </button>
        <button className={act == "3" ? "btn active" : "btn"} onClick={setAct}>
          3
        </button>
        <button className={act == "4" ? "btn active" : "btn"} onClick={setAct}>
          4
        </button>
        <button className={act == "5" ? "btn active" : "btn"} onClick={setAct}>
          5
        </button>
      </div>
      <div className="submit-button-container">
        <button className="submit" onClick={(e) => setOnOff()}>
          SUBMIT
        </button>
      </div>
    </div>
...
function ThankyouComp({ act, onOff }) {
  return (
    <div className={`main-container-2 ${onOff ? "off" : ""}`}>
      <MySvgComponent />
      <div className="out-of">
        <p>You selected {act} out of 5</p>
      </div>
